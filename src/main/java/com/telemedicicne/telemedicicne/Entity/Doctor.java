...
//    private String currentCallStatus;
    ...
    @ManyToOne
    @JoinColumn(name = "healthOfficer_id")
    private HealthOfficer healthOfficer;
//@OneToMany(mappedBy = "doctor", cascade = CascadeType.ALL)
//private Set<HealthOfficer> healthOfficers = new HashSet<>();
...
//    private Set<Role> roles = new HashSet<>();
    ...
    public void receiveVideoTokenFromHealthOfficer(String token, HealthOfficer sender) {
        this.videoToken = token;
        this.healthOfficer = sender;
    }
